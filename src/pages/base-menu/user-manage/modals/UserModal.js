...
class UserModal extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Form>
          <Form.Item {...formItemLayout} label="登入名称">
          ...
          <Form.Item {...formItemLayout} label="真实名称">
          ...
          <Form.Item {...formItemLayout} label="所属角色">
            ...
            })(<CustomGroupSelect url="/api/user/findGroupRoleSelect" />)}
          </Form.Item>
          ...
          <Form.Item {...formItemLayout} label="会话/分">
