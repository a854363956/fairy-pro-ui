export default {
  'user-login.login.msg.WRONG_PASSWORD': '密码错误,请重新输入',
  'user-login.login.msg.USER_DOES_NOT_EXIST': '账号输入错误请重新输入',
  'user-login.login.msg.SYSTEM_ERROR': '系统错误,请联系管理员',
  'user-login.login.msg.UNMAINTAINED_ROLES': '当前用户未维护角色信息',
